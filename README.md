...
> **A sua saúde financeira, simplificada.**
> Uma Aplicação Web Progressiva (PWA) inteligente que transforma a gestão de finanças pessoais.
...
### 🛠️ Tecnologia & Experiência
*   **PWA Offline-First**: Funciona sem internet e instala-se como uma app nativa no seu telemóvel ou PC.
*   **Segurança (Supabase)**: Autenticação robusta, Row Level Security (os seus dados são só seus) e backups automáticos.
*   **Personalização**: Temas (Dark/Light), modo de privacidade e configuração granular de notificações.

---

## 💻 Tech Stack

Construído com tecnologias modernas para performance e simplicidade:
*   **Frontend**: Vanilla JS, CSS3, HTML5 (Leve e rápido)
...
**Desenvolvido por António Rappleton**
